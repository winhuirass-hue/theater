...
#ifndef HAVE_theater_GST_PIXBUF_HELPERS_H
#define HAVE_theater_GST_PIXBUF_HELPERS_H
...
GdkPixbuf * theater_gst_playbin_get_frame (GstElement *play);

GdkPixbuf * theater_gst_tag_list_get_cover (GstTagList *tag_list);

G_END_DECLS

#endif				/* HAVE_theater_GST_PIXBUF_HELPERS_H */
