...
const char *
theater_subtitle_encoding_get_selected (GtkComboBox * combo)
{
  GtkTreeModel *model;
  GtkTreeIter iter;
...
void
theater_subtitle_encoding_set (GtkComboBox * combo, const char *encoding)
{
  GtkTreeModel *model;
  GtkTreeIter iter, iter2;
  gint enc_index, i;
...
void
theater_subtitle_encoding_init (GtkComboBox *combo)
{
  GtkTreeModel *model;
