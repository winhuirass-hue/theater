...
#ifndef HAVE_theater_GST_HELPERS_H
#define HAVE_theater_GST_HELPERS_H
...
void theater_gst_message_print (GstMessage *msg,
			      GstElement *play,
			      const char *filename);

void theater_gst_disable_display_decoders (void);

G_END_DECLS

#endif				/* HAVE_theater_GST_HELPERS_H */
